...
const Exam = () => {
    ...
    snapshotIntervalRef.current = setInterval(() => {
      if (webcamRef.current) {
        ...
        if (imageSrc) {
          setSnapshots((prev) => [
            ...prev,
            { image: imageSrc, timestamp: new Date().toISOString() },
          ]);
        }
      }
    }, 10000);
  ...
  if (loading) {
    return (
      <div className="p-8 bg-gray-900 text-white min-h-screen flex justify-center items-center text-xl font-semibold">
        Loading questions...
      </div>
    );
  }
  ...
  return (
    <div className="p-8 bg-gray-900 text-white min-h-screen w-full">
      <h1 className="text-3xl mb-4 font-extrabold tracking-wide">
        Exam in Progress
      </h1>
